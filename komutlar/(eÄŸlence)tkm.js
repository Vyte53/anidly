...
exports.run = async (client, msg, args) => {
    if (!args[0]) {
        return msg.channel.send('Lütfen seçimini yap `taş, kağıt` yada `makas` Örnek Kullanım: `+tkm makas`');
    }
